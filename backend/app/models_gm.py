...
from .db_async import BaseAsync as Base
...
class GmCountry(Base):
    ...
    s5_1_uz = Column(Text, nullable=True)  # Экспорт – страна 1: название (UZ)
    ...
    s5_3_uz = Column(Text, nullable=True)  # Экспорт – страна 2: название (UZ)
    ...
    s5_5_uz = Column(Text, nullable=True)  # Экспорт – страна 3: название (UZ)
    ...
    s5_7_uz = Column(Text, nullable=True)  # Импорт – страна 1: название (UZ)
    ...
    s5_9_uz = Column(Text, nullable=True)  # Импорт – страна 2: название (UZ)
    ...
    s5_11_uz = Column(Text, nullable=True)  # Импорт – страна 3: название (UZ)
...
class GmCity(Base):
    ...
    s5_4_uz = Column(Text, nullable=True)  # Экспорт – страна 3: название (UZ)
    ...
    s5_6_uz = Column(Text, nullable=True)  # Импорт – страна 1: название (UZ)
    ...
    s5_8_uz = Column(Text, nullable=True)  # Импорт – страна 2: название (UZ)
    ...
    s5_10_uz = Column(Text, nullable=True)  # Импорт – страна 3: название (UZ)
    ...
    s20_1_uz = Column(Text, nullable=True)  # Махалля 1: название (UZ)
    ...
    s20_4_uz = Column(Text, nullable=True)  # Махалля 2: название (UZ)
    ...
    s20_7_uz = Column(Text, nullable=True)  # Махалля 3: название (UZ)
    ...
    s20_10_uz = Column(Text, nullable=True)  # Махалля 4: название (UZ)
    ...
    s20_15_uz = Column(Text, nullable=True)  # Махалля 1: название (UZ)
    ...
    s20_18_uz = Column(Text, nullable=True)  # Махалля 2: название (UZ)
    ...
    s20_21_uz = Column(Text, nullable=True)  # Махалля 3: название (UZ)
    ...
    s20_24_uz = Column(Text, nullable=True)  # Махалля 4: название (UZ)
    ...
    s20_27_uz = Column(Text, nullable=True)  # Махалля 5: название (UZ)
    ...
    s21_1_uz = Column(Text, nullable=True)  # Проблема 1: название (UZ)
    ...
    s21_4_uz = Column(Text, nullable=True)  # Проблема 2: название (UZ)
    ...
    s21_7_uz = Column(Text, nullable=True)  # Проблема 3: название (UZ)
    ...
    s21_10_uz = Column(Text, nullable=True)  # Проблема 4: название (UZ)
    ...
    s21_13_uz = Column(Text, nullable=True)  # Проблема 5: название (UZ)
