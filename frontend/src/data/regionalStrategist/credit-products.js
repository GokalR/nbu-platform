...
export const CREDIT_PRODUCTS = [
  // ── Облегченные продукты ───────────────────────────────────────────────
  {
    ...
    amountLabel: { ru: 'do 3,5 mlrd sum (oblegch.) · do 10 mlrd (standart)', uz: '3,5 mlrd so'mgacha (eng.) · 10 mlrd (standart)' },
  ...
  },
  {
    ...
    amountLabel: { ru: 'do 1 mlrd sum', uz: '1 mlrd so'mgacha' },
    collateral: ['insurance'],
    purposes: ['any'],
    purposeLabel: { ru: 'Lyubie tseli', uz: 'Har qanday maqsad' },
  },
  {
    ...
    amountLabel: { ru: 'do 300 mln sum', uz: '300 mln so'mgacha' },
    collateral: ['realEstate', 'vehicle', 'insurance'],
    collateralNote: { ru: 'straxovoy polis — do 30%', uz: 'sug'urta polisi — 30% gacha' },
    purposes: ['working', 'fixed'],
    purposeLabel: { ru: 'Oborotnie ili osnovnie sredstva', uz: 'Aylanma yoki asosiy vositalar' },
  },
  {
    ...
    amountLabel: { ru: 'do 1,5 mlrd sum', uz: '1,5 mlrd so'mgacha' },
    collateral: ['realEstate', 'vehicle'],
    purposes: ['any'],
    purposeLabel: { ru: 'Lyubie tseli', uz: 'Har qanday maqsad' },
  },
  {
    ...
    amountLabel: { ru: 'do 3,5 mlrd sum', uz: '3,5 mlrd so'mgacha' },
  ...
  },
  {
    ...
    collateralNote: { ru: 'straxovoy polis — do 30%', uz: 'sug'urta polisi — 30% gacha' },
    purposes: ['working'],
    purposeLabel: { ru: 'Popolnenie oborotnix sredstv', uz: 'Aylanma mablag'larni to'ldirish' },
  },
  {
    id: 'razvivaysya',
  ...
  },
  {
    ...
    purposes: ['realEstate'],
    purposeLabel: { ru: 'Pokupka kommercheskoy nedvijimosti ot zastroyshikov', uz: 'Quruvchilardan tijorat ko'chmas mulkini sotib olish' },
  },
...
const COLL_LABELS = {
  realEstate: { ru: 'Nedvijimost', uz: 'Ko'chmas mulk' },
  vehicle: { ru: 'Avtotransport', uz: 'Avtotransport' },
  insurance: { ru: 'Straxovoy polis', uz: 'Sug'urta polisi' },
