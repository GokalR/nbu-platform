...
export const FERGANA_CONTEXT = {
  ...
  highlights: {
    ...
    uz: [
      ...
      'Sanoat 2024: 45,896 mlrd so\ʻm (+104.3%)',
      'Investitsiyalar 2023: 19,955 mlrd so\ʻm (+29.4%)',
      'Qayta ishlovchi sanoat 2023 yilda 104% ga o\ʻsdi',
      'Hudud: 6.76 ming km², 15 tuman + 4 shahar',
      'Eksport: Afg\ʻoniston $53 mln, Eron $40 mln (2023)',
      'Investitsiyalarning 61.6% — korxonalar o\ʻz mablag\ʻlari',
      '2024 yilda qurilish o\ʻsishi — 103.9%',
      '855 to\ʻqimachilik korxonasi (stat.uz, 2021)',
      'Farg\ʻona vodiysi — asosiy to\ʻqimachilik va agrosanoat klasteri',
    ],
  },
