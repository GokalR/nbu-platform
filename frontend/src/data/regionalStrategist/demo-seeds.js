...
export const DEMO_SEEDS = {
  erkinParvoz: {
    ...
    uz: {
      ...
      finance: {
        businessDirection: 'O'quv markazi',
        ideaDescription:
          'Marg'ilonda IT yo'nalishidagi amaldagi o'quv markazi. 1 filial, 6 o'qituvchi, ~80 talaba. Bahrin mahallasida AI/ML, data science va kiber xavfsizlik yo'nalishlarida ikkinchi filial ochishni rejalashtirmoqdamiz.',
        whyThisBusiness: 'Bu sohada tajribam bor',
        targetCustomer: 'Jismoniy shaxslar (B2C)',
        hasOwnFunds: 'Ha',
        hasSpace: 'Yo'q, ijara kerak',
        hasEquipment: 'Qisman',
