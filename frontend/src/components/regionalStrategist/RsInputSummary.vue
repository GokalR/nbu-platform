...
const L = {
  ...
  uz: {
    ...
    fields: {
      ...
      hasHigherEducation: 'Oliy ta'lim', educationField: 'Ta'lim yo'nalishi',
      maritalStatus: 'Oilaviy holat', dependents: 'Ijdiventlar',
      currentStatus: 'Hozirgi holat', experienceLevel: 'Ish tajribasi',
      domainExperience: 'Sohadagi tajriba', hasTraining: 'O'qitishdan o'tgan',
      ...
      entityType: 'Sub'ekt turi', registrationForm: 'Ro'yxatga olish shakli',
      businessSize: 'Biznes hajmi',
      businessDirection: 'Biznes yo'nalishi', hasBusinessPlan: 'Biznes-reja bor',
      needsLoan: 'Kredit kerak', hasOwnFunds: 'O'z mablag'lari',
      ...
      hasRegisteredBusiness: 'Biznes ro'yxatdan o'tgan', businessGoal: 'Kredit maqsadi',
      timeline: 'Muddatlar', hasSpace: 'Bino bor', hasEquipment: 'Jihoz bor',
      ideaDescription: 'G'oya tavsifi', whyThisBusiness: 'Nega bu biznes',
