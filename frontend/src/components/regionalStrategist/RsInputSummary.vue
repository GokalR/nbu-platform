...
const L = {
  ...
  uz: {
    ...
    empty: '—',
    fields: {
      name: 'Ism', ageRange: 'Yosh', gender: 'Jinsi',
      hasHigherEducation: 'Oliy taʻlim', educationField: 'Taʻlim yoʻnalishi',
      maritalStatus: 'Oilaviy holat', dependents: 'Ijdiventlar',
      currentStatus: 'Hozirgi holat', experienceLevel: 'Ish tajribasi',
      domainExperience: 'Sohadagi tajriba', hasTraining: 'Oʻqitishdan oʻtgan',
      hasMentor: 'Mentor bor', viloyat: 'Viloyat', hudud: 'Shahar / tuman',
      mahalla: 'Mahalla', urbanRural: 'Joy turi',
      businessAge: 'Biznes yoshi', employeeCount: 'Xodimlar',
      entityType: 'Subʻekt turi', registrationForm: 'Roʻyxatga olish shakli',
      businessSize: 'Biznes hajmi',
      businessDirection: 'Biznes yoʻnalishi', hasBusinessPlan: 'Biznes-reja bor',
      needsLoan: 'Kredit kerak', hasOwnFunds: 'Oʻz mablagʻlari',
      hasCollateral: 'Garov bor', collateralType: 'Garov turi',
      loanAmount: 'Kredit summasi', monthlyIncome: 'Oylik daromad',
      monthlyExpenses: 'Oylik xarajat', existingDebt: 'Hozirgi qarz',
      hasRegisteredBusiness: 'Biznes roʻyxatdan oʻtgan', businessGoal: 'Kredit maqsadi',
      timeline: 'Muddatlar', hasSpace: 'Bino bor', hasEquipment: 'Jihoz bor',
      ideaDescription: 'Gʻoya tavsifi', whyThisBusiness: 'Nega bu biznes',
      targetCustomer: 'Maqsadli mijoz', mainProblem: 'Asosiy muammo',
    },
  },
}
