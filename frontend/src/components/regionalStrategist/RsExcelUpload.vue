...
const L = {
  ...
  uz: {
    ...
    pnlDesc: 'Davr uchun tushum, tannarx va foyda.',
    dropZone: 'Faylni bu erga tashlang yoki',
    browse: 'tanlang',
    uploading: 'Qayta ishlanmoqda…',
    uploaded: 'Qabul qilindi',
    error: 'Xato',
    analyzeBtn: 'Tahlilni yaratish',
    analyzing: 'Tahlil qilinyapti…',
    analysisReady: 'Tahlil tayyor',
    again: 'Qayta yaratish',
    privacyNote: 'Fayllar brauzeringizdan chiqmaydi — faqat yuklash faktini tasdiqlash uchun.',
  },
}
