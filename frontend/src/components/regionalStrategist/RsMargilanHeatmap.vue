...
const HEATMAP_T = {
  ...
  uz: {
    title: 'Imkoniyatlar issiqlik xartasi — Margʻilon',
    sub: 'Har bir mahallaning taʻlim kurslari uchun potentsiali',
    source: 'Manba: OSM + NBU Data Office',
    popLabel: 'Shahar aholisi',
    avgLabel: 'Oʻrt. ball',
    centersLabel: 'Oʻquv markazlari',
    bestLabel: '★ Eng yaxshi mahalla',
    bestBadge: '★ ENG YaXShI VARIANT',
    subsectorsLabel: 'Kurs yoʻnalishlari',
    ...
    mahallaWord: 'mahalla',
    legend: [
      { color: '#059669', label: 'Aʻlo', range: '85–100' },
      { color: '#2957A2', label: 'Yaxshi', range: '75–84' },
      { color: '#D7B56D', label: 'Oʻrtacha', range: '60–74' },
