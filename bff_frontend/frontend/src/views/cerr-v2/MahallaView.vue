...
/* Rating callout CSS (.mh-rating-card, .mh-rank-pill, .mh-rating-num,
 * .mh-rating-lbl, .mh-rating-ranks) lives in src/styles/cerr-v2-theme.css
 * so it loads on every cerr-v2 page, not just when MahallaView is mounted.
 */
