...
def build_evidence_prompt(pack: EvidencePack, brief: AnswerBrief | None = None) -> str:
    ...
    return (
        ...
        "8. Bold markdown `**X**` is FRAGILE — three things will make it\n"
        "   render as literal asterisks instead of bold text:\n"
        ...
        "   The same three rules apply to single-asterisk italics `*X*`,\n"
        "   and to Russian, Uzbek Cyrillic, and English suffixes alike.\n"
        "   Quick reference: the asterisks must hug the text tightly inside,\n"
        "   and the next char outside must be whitespace or punctuation.\n"
