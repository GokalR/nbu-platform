...
METRIC_TO_VIEW: dict[str, str] = {
    ...
    # Phase 2A — business directory (companies)
    "oked_label_ru": "v_companies",
    "oked_label_uz": "v_companies",
    "client_type_cyr": "v_companies",
    # Phase 2A — business directory (TN_VED imports)
    "tnved_code": "v_business_imports",
    "tnved_chapter": "v_business_imports",
    "tnved_description_ru": "v_business_imports",
    "value_usd": "v_business_imports",
    "declaration_date": "v_business_imports",
    "origin_country_code": "v_business_imports",
    # Phase 2A — per-importer summaries
    "total_import_usd": "v_business_import_summaries",
    "value_machines_usd": "v_business_import_summaries",
    "value_chemicals_usd": "v_business_import_summaries",
    "value_misc_goods_usd": "v_business_import_summaries",
    "value_industrial_usd": "v_business_import_summaries",
    "value_animal_oils_usd": "v_business_import_summaries",
    "value_non_food_raw_usd": "v_business_import_summaries",
    "value_building_mats_usd": "v_business_import_summaries",
    "value_food_products_usd": "v_business_import_summaries",
    "value_fruit_veg_usd": "v_business_import_summaries",
    "value_mineral_fuel_usd": "v_business_import_summaries",
    "value_beverages_tobacco_usd": "v_business_import_summaries",
    "value_other_goods_usd": "v_business_import_summaries",
    # Phase 2A — pre-aggregated company density
    "company_count": "v_company_density_by_district",
}
...
METRIC_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    # Phase 2A — business directory (companies / OKED activity)
    "kompaniya": ("company_count", "oked_label_uz"),
    "kompaniyalar": ("company_count", "oked_label_uz"),
    "company": ("company_count", "oked_label_uz"),
    "soha": ("oked_label_uz", "oked_label_ru"),
    "yo'nalish": ("oked_label_uz", "oked_label_ru"),
    "faoliyat turi": ("oked_label_uz", "oked_label_ru"),
    "oked": ("oked_label_uz", "oked_label_ru"),
    "okd": ("oked_label_uz",),
    "сфера": ("oked_label_ru",),
    "вид деятельности": ("oked_label_ru",),
    "tadbirkorlik faoliyati": ("oked_label_uz", "oked_label_ru"),
    "restoran": ("oked_label_uz", "oked_label_ru"),
    "kafe": ("oked_label_uz", "oked_label_ru"),
    "chakana savdo": ("oked_label_uz",),
    "ulgurji savdo": ("oked_label_uz",),
    "savdo": ("oked_label_uz", "oked_label_ru"),
    # Phase 2A — imports / TN_VED
    "import": ("value_usd", "total_import_usd"),
    "importer": ("value_usd", "total_import_usd"),
    "import qilgan": ("value_usd", "total_import_usd"),
    "import qiluvchi": ("value_usd", "total_import_usd"),
    "import qilingan": ("value_usd",),
    "olib kelgan": ("value_usd",),
    "import summasi": ("total_import_usd",),
    "импорт": ("value_usd", "total_import_usd"),
    "импортёр": ("value_usd", "total_import_usd"),
    "импортер": ("value_usd", "total_import_usd"),
    "tn ved": ("tnved_code", "tnved_description_ru"),
    "tn-ved": ("tnved_code", "tnved_description_ru"),
    "tnved": ("tnved_code",),
    "тн вэд": ("tnved_code",),
    "mahsulot kodi": ("tnved_code",),
    "tovar kodi": ("tnved_code",),
    "deklaratsiya": ("declaration_date", "declaration_number"),
    "декларация": ("declaration_date",),
    "kelib chiqgan davlat": ("origin_country_code",),
    "yetkazib beruvchi": ("value_usd", "total_import_usd"),
    "поставщик": ("value_usd", "total_import_usd"),
    # Phase 2A — product categories (from import_summaries)
    "mashina ускуна": ("value_machines_usd",),
    "machines": ("value_machines_usd",),
    "kimyo mahsulot": ("value_chemicals_usd",),
    "qurilish materiali": ("value_building_mats_usd",),
    "oziq-ovqat": ("value_food_products_usd",),
    "продукты питания": ("value_food_products_usd",),
    "mineral yoqilg'i": ("value_mineral_fuel_usd",),
    "yoqilg'i": ("value_mineral_fuel_usd",),
    "tamaki": ("value_beverages_tobacco_usd",),
    "ichimlik": ("value_beverages_tobacco_usd",),
    "meva sabzavot": ("value_fruit_veg_usd",),
}
